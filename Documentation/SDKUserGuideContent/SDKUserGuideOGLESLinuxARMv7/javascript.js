...
{
	var sections = new Array("ContentsSection","InstallationSection","ExamplesSection","ShellSection","ToolsSection","DocumentationSection","ContactSection");
	var i;
	for (i=0;i<7;i++)
	{
...
function printVersion()
{
    ...
    // TODO: open all collapsed demos, training courses etc.
}
